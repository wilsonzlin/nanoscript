...
import static in.wilsonl.nanoscript.Parsing.TokenType.T_KEYWORD_OPTIONAL;
...
public class CallExpression extends Expression {
  ...
  public static Arguments parseCallExpressionArguments (Tokens tokens) {
    ...
    do {
      ...
      Expression value = parseExpression(tokens, new AcceptableTokenTypes(T_COMMA, T_RIGHT_PARENTHESIS));
