...
public class ShuntingYard {
  ...
  public void processShuntingYard (Operator operatorInProcessing) {
    ...
    while (hasOperator()) {
      ...
      if (!operatorInProcessingProvided ||
          (operatorAssociativity == LEFT && operatorPrecedence <= lastOperatorPrecedence ||
           operatorAssociativity == RIGHT && operatorPrecedence < lastOperatorPrecedence)) {
        removeLastOperator();
        ...
        case NULL_CALL:
          ...
          result = new CallExpression(
            ...
            lastOperator == Operator.NULL_CALL,
            callee,
            (CallExpression.Arguments) lastOperatorData);
          break;
